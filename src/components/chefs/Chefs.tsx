  ...
  const [boldName, setBoldName] = useState("all")
      ...
      return (<>
        ...
        <div className="filters">
          ...
          <Clean_button name="all" bold={boldName === "all"} onClick={() => setBoldName("all")}>All</Clean_button>         
          <Clean_button name="new" bold={boldName === "new"} onClick={() => setBoldName("new")}>New</Clean_button>
          <Clean_button name="most_viewed" bold={boldName === "most_viewed"} onClick={() => setBoldName("most_viewed")}>Most Viewed</Clean_button>
          </div>
        </div>
